                        ...
                        code: ({ node, ...props }) => (
                          ...
                          pre: ({ node, ...props }) => {
                            ...
                            return(
                              ...
                              <button onClick={() => handleCopy(currentIndex)} className='absolute top-2 right-10 flex text-sm items-center font-light '>
                                {copyStatus[currentIndex] ? "Copied" : <CopyIcon />} {copyStatus[currentIndex] ? null : <p className="text-sm font-base">copy code</p>}
                              </button>
                            </div>
                            )
                          },
